...
public class PrepareRouteResponse {
    ...
    public RouteFinderResponse prepare(List<RouteNode> route, LocalDateTime departureTime, int avgSpeedKmh) {
        ...
        return new RouteFinderResponse(formatDuration(totalSeconds), departureTime.plusSeconds(totalSeconds), totalDistanceKm, route);
    }
